...
\subsubsection{\enquote{It follows that $U_\theta(1)$ is stationary under any infinitesimal variation of the path that leaves the endpoints $\Theta(0)=0$ and $\Theta(1)=\theta$ (and $U_\theta(0)=\identity$) fixed.} \page{98}}
We have 
